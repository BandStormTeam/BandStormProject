                ...
                <div class="bs-example" data-example-id="media-alignment">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Jordan Lemoine<br>
                                <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Bordeaux
                            </p>
                        </div>
                    </div>
                    <div class="media">
