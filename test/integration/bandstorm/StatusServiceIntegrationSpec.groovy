...
class StatusServiceIntegrationSpec extends Specification {
    ...
    void "test getStatusforTimeline method"() {
        ...
        def status1 = new Status(content: "My status test 1", lightCount: 0, author: user1).save(flush: true)
        def status2 = new Status(url: "http://www.google.fr", content: "My status test 2", lightCount: 0, author: user1).save(flush: true)
